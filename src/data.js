export const questions = [
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Helt uenig", value: -2, parties: ["Norgesdemokratene", "Konservativt"] },
      { id: "B", text: "Litt uenig", value: -1, parties: ["FrP", "Industri- og Næringspartiet"] },
      { id: "C", text: "Nøytral", value: 0, parties: ["Partiet DNI", "Generasjonspartiet"] },
      { id: "D", text: "Litt enig", value: 1, parties: ["H", "SV", "R", "Sp", "Pensjonistpartiet", "FOR", "Velferd og Innovasjonspartiet", "Ensomhetspartiet"] },
      { id: "E", text: "Helt enig", value: 2, parties: ["AP", "KrF", "V", "MDG", "Partiet Sentrum"] },
    ],
  },
  // Miljøpolitikk
  {
    ...
    text: "Norge må fortsette med olje- og gassutvinning.",
    options: [
      { id: "A", text: "Helt uenig", value: -2, parties: ["AP", "KrF", "SV", "R", "MDG", "V", "FOR", "Generasjonspartiet", "Partiet Sentrum", "Pensjonistpartiet", "Velferd og Innovasjonspartiet"] },
      { id: "B", text: "Litt uenig", value: -1, parties: ["Sp"] },
      { id: "C", text: "Nøytral", value: 0, parties: ["Ensomhetspartiet"] },
      { id: "D", text: "Litt enig", value: 1, parties: ["H"] },
